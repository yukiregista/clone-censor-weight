...
def load_scenario2_parameters():
    text = read_yaml_text("scenario2.yaml", __package__)
...
def load_scenario2_params_and_variables():
    PARAMETERS = load_scenario2_parameters()
    LAG_CONFIGS = LagConfigs.get_scenario2_lags()
    AllVariables = [Variable(
        ...
        CPD=A_CPD_wo_SPO2(**PARAMETERS[ScenarioVariables.A.name]),
    ),
        Variable(
